...
<nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../visiteurs/liste.php">
        ...
        <td>'.$s['quantite']. '</td>
        <td>
          <a data-toggle="modal" data-target="#exampleModal'.$s['id'].'"  class=" btn btn-success">Modifier</a>
          
          <a onclick = "return poUpDeleteCategorie()" href="supprimer.php?idc='.$s['id'].' " class=" btn btn-danger"> Supprimer</a>
        </td>
      </tr>';
                            }
                            ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="modifier.php" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" name="quantite" class="form-control" placeholder="Nom de la catégorie" value="<?php echo $stock['quantite'] ?>">
                    </div>
